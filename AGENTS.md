...
**@everydaydevopsio/ballast** — CLI that installs TypeScript AI agent rules (linting, local-dev, CI/CD, observability, logging) into the right places for Cursor, Claude Code, OpenCode, or Codex.
