...
6. Add a maintained `pre-commit` workflow for lint, YAML validation, and syntax checks.
7. Add CI steps that run linting before any apply/deploy workflow.
...
4. Add or update `.pre-commit-config.yaml`.
...
1. Show the user the linting and hook files you added or updated.
