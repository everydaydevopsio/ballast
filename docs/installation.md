...
- Skills install into target-specific skill locations such as `.claude/skills/aws-health-review.skill`, `.opencode/skills/aws-live-health-review.md`, and `.cursor/rules/aws-weekly-security-review.mdc`
