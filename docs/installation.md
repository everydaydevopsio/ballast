...
- TypeScript-only Husky pre-commit hooks should use `lint-staged` or the repository formatter/linter for fast checks, including both `.yaml` and `.yml` formatting.
